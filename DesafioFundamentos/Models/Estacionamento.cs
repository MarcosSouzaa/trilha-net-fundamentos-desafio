namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            {
                Console.WriteLine("Essa placa já foi inserida!");
            }
            else
            {
                veiculos.Add(placa);
                Console.WriteLine("Este veículo foi adicionado com sucesso!");
            }          
        }
        ...
        public void RemoverVeiculo()
        {
            ...
            // Verifica se o veículo existe e se é igual a placa digitada
